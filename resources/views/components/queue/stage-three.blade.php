<div x-data="{
    ...
    <div x-show="queue_type === 'with_down_payment'" class="space-y-6">
        <div>
            <h3 class="text-lg font-semibold text-gray-900 mb-2">Сумма первоначального взноса</h3>
            <input
                    type="number"
                    name="down_payment"
                    min="500000"
        ...
        <div>
            <h3 class="text-lg font-semibold text-gray-900 mb-2">Срок оплаты</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <template x-for="term in ['2','4','5','6']" :key="term">
                    <label
                            class="block p-4 cursor-pointer bg-white rounded-[24px] shadow-sm border hover:border-yellow-400 hover:bg-[#FFFCEA] transition duration-150 ease-in-out"
