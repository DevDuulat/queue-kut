<div x-show="queue_type === 'without_down_payment'">
    ...
    <div class="grid grid-cols-2 gap-4">
        <label class="block p-4 h-full rounded-[24px] cursor-pointer shadow-sm border bg-white transition duration-150 ease-in-out hover:border-yellow-400 hover:bg-[#FFFCEA]"
               :class="monthly_payment === '40000' ? 'border-yellow-400 bg-[#FFFCEA]' : 'border-gray-200'">
            <input type="radio" name="monthly_payment" value="40000" x-model="monthly_payment" class="sr-only">
            <div class="flex items-center space-x-3">
                <div class="w-4 h-4 rounded-full border flex items-center justify-center"
                     :class="monthly_payment === '40000' ? 'border-yellow-400' : 'border-gray-400'">
                    <div x-show="monthly_payment === '40000'" class="w-2 h-2 rounded-full bg-yellow-400"></div>
                </div>
        ...
        <label class="block p-4 h-full rounded-[24px] cursor-pointer shadow-sm border bg-white transition duration-150 ease-in-out hover:border-yellow-400 hover:bg-[#FFFCEA]"
               :class="monthly_payment === '60000' ? 'border-yellow-400 bg-[#FFFCEA]' : 'border-gray-200'">
            <input type="radio" name="monthly_payment" value="60000" x-model="monthly_payment" class="sr-only">
            <div class="flex items-center space-x-3">
                <div class="w-4 h-4 rounded-full border flex items-center justify-center"
                     :class="monthly_payment === '60000' ? 'border-yellow-400' : 'border-gray-400'">
                    <div x-show="monthly_payment === '60000'" class="w-2 h-2 rounded-full bg-yellow-400"></div>
                </div>
        ...
        <label class="block p-4 h-full rounded-[24px] cursor-pointer shadow-sm border bg-white transition duration-150 ease-in-out hover:border-yellow-400 hover:bg-[#FFFCEA]"
               :class="monthly_payment === '80000' ? 'border-yellow-400 bg-[#FFFCEA]' : 'border-gray-200'">
            <input type="radio" name="monthly_payment" value="80000" x-model="monthly_payment" class="sr-only">
            <div class="flex items-center space-x-3">
                <div class="w-4 h-4 rounded-full border flex items-center justify-center"
                     :class="monthly_payment === '80000' ? 'border-yellow-400' : 'border-gray-400'">
                    <div x-show="monthly_payment === '80000'" class="w-2 h-2 rounded-full bg-yellow-400"></div>
                </div>
        ...
        <label class="block p-4 h-full rounded-[24px] cursor-pointer shadow-sm border bg-white transition duration-150 ease-in-out hover:border-yellow-400 hover:bg-[#FFFCEA]"
               :class="monthly_payment === 'other' ? 'border-yellow-400 bg-[#FFFCEA]' : 'border-gray-200'">
            <input type="radio" name="monthly_payment" value="other" x-model="monthly_payment" class="sr-only">
            <div class="flex items-center space-x-3">
                <div class="w-4 h-4 rounded-full border flex items-center justify-center"
                     :class="monthly_payment === 'other' ? 'border-yellow-400' : 'border-gray-400'">
                    <div x-show="monthly_payment === 'other'" class="w-2 h-2 rounded-full bg-yellow-400"></div>
                </div>
    ...
    <div x-show="monthly_payment === 'other'" class="mt-6">
...
<div x-show="queue_type === 'with_down_payment'">
    <div class="grid grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input type="text" name="down_payment" placeholder="Минимальная сумма: 1 000 000 сом"
        ...
        <div>
            ...
            <input type="text" name="monthly_payment_custom" placeholder="Например: 60 000 сом"
                   x-model="custom_monthly"
        ...
        <label class="block p-4 h-full rounded-[24px] cursor-pointer  bg-white transition duration-150 ease-in-out hover:border-yellow-400 hover:bg-[#FFFCEA]"
