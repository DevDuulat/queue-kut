    ...
    <div x-show="queue_type === 'with_down_payment'">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <template x-for="term in ['2','4','5','6']" :key="term">
                <label
                        class="block p-4 h-full cursor-pointer bg-white rounded-[24px] shadow-sm border hover:border-yellow-400 hover:bg-[#FFFCEA] transition duration-150 ease-in-out"
