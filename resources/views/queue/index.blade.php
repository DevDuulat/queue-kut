<x-layouts.app title="Очередь на квартиру">
    <div x-data="{
        ...
        apartment_type: '1_room'
            ...
            class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 mobile-height-fix lg:max-h-screen lg:overflow-hidden p-0 lg:p-6"
    >
    ...
    <div class="h-full rounded-[24px] hidden lg:block">
        ...
        <div class="bg-[#F5F5F5] flex flex-col items-center lg:col-span-2 rounded-[24px] border border-gray-100 h-full lg:p-6">
            ...
            <div class="w-full max-w-3xl mx-auto h-[380px]">
                <div x-show="currentStage === 1" class="h-full">
                    <x-queue.stage-one />
                </div>

                <div x-show="currentStage === 2" class="h-full overflow-auto">
                    <x-queue.stage-two />
                </div>
                <div x-show="currentStage === 3" class="h-full overflow-auto">
                    <x-queue.stage-three />
                </div>
            </div>
